...
/**
 * English language strings for the enrolment suspension tool.
 *
 * @package    tool_enrolsuspension
 * @copyright  2026 Murillo Enrique
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

defined('MOODLE_INTERNAL') || die();
$string['activesuspensions'] = 'Active suspensions';
$string['allhistoryrecords'] = 'All records';
...
$string['enrolinstanceid'] = 'Enrolment instance ID';
...
$string['enrolmenttechnicaltype'] = 'Technical enrolment type';
...
$string['exporthistory'] = 'Export current history to Excel';
$string['exporthistoryexcel'] = 'Export history to Excel (.xlsx)';
$string['history'] = 'History';
$string['historyoperationexplanation'] = 'Operations are numbered sequentially in the history (OP-0001, OP-0002, ...). The same code appears on multiple rows when several enrolment links were suspended in the same operation.';
$string['historyrecordid'] = 'Record ID';
$string['historystatusreactivated'] = 'Reactivated';
$string['historystatusstale'] = 'Stale';
$string['historystatussuspended'] = 'Suspended';
$string['idnumberlabel'] = 'ID number';
$string['importcsv'] = 'Import CSV/TXT';
$string['legacyrecord'] = 'Legacy';
...
$string['operationinternalid'] = 'Internal operation ID';
...
$string['reactivatedby'] = 'Reactivated/changed by';
...
$string['reactivationdate'] = 'Reactivation/status-change date';
...
$string['staleexplanation'] = 'A stale record means the exact enrolment link originally suspended no longer exists or its state ' .
    'was changed outside this plugin. For safety, the plugin will not reactivate a new or different enrolment link in ' .
    'its place.';
$string['staleshortexplanation'] = 'Original link removed or changed outside the plugin';
...
$string['unknownenrolmentmethod'] = 'Unknown/unavailable enrolment method';
$string['unknownoperator'] = 'Unknown/deleted operator';
$string['unknownstatus'] = 'Unknown status';
...
$string['userenrolmentid'] = 'User enrolment link ID';
